...
namespace RoutePlanning
{
    internal static class Program
    {
        ...
        {
            RunTests(1, My_PathFinderTask.FindBestCheckpointsOrder);
            RunTests(2, My_PathFinderTask.FindBestCheckpointsOrder);
            Console.WriteLine();
            Console.WriteLine("Большие тесты. Реализуйте отсечение перебора, чтобы они проходили быстро");
            RunTests(3, My_PathFinderTask.FindBestCheckpointsOrder);
